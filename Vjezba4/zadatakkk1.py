...
pozitron_x_3, pozitron_y_3, pozitron_z_3=simuliranjee(naboj_pozitrona, masa_pozitrona, 0, 0, 0.01, 0, 0, 1500)
...
osx_2.plot(elektron_x_2, elektron_y_2, elektron_z_2, label='Putanja elektrona u električnom polju')
osx_2.plot(pozitron_x_2, pozitron_y_2, pozitron_z_3, label='Gibanje u elektricnom polju')
osx_2.set_title('Gibanje u električnom polju z -os')
osx_2.legend()
osx_3=plt.subplot(133, projection='3d')
osx_3.plot(elektron_x_3, elektron_y_3, elektron_z_3, label='Putanja elektrona kada na njega djeluje i magnetsko i elektricno polje')
osx_3.plot(pozitron_x_3, pozitron_y_3, pozitron_z_3, label='Putanja pozitrona u elektricnom i magnetskom polju')
osx_3.set_title('Gibanje u električnom i magnetskom polju')
osx_3.legend()
plt.tight_layout()
plt.show()
